...
public class BookDetailAdapter extends BaseQuickAdapter<RecommendBookListBean.BooklistsBean,BaseViewHolder> {

    public BookDetailAdapter(@LayoutRes int layoutResId, @Nullable List<RecommendBookListBean.BooklistsBean> data) {
