...
public class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) Util.getContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) Util.getContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) Util.getContext()
